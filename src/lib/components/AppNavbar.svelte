<script lang="ts">
	...
	const links: {
		...
		{ label: "Miz File Diff", icon: FileArchive, path: "/diff" },
		{ label: "Documentation", icon: Book, path: "/docs" },
		{ label: "Support", icon: CircleHelp, href: "https://github.com/JonathanTurnock/dcsfiddle/issues" },
		{ label: "Github", icon: GithubIcon, href: "https://github.com/JonathanTurnock/dcsfiddle" },
	];
